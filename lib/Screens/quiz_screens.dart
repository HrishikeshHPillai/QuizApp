...
import 'package:robocet_new/Screens/quiz_error.dart';
import 'package:robocet_new/controllers/quiz/quiz_controller.dart';
import 'package:robocet_new/controllers/quiz/quiz_state.dart';
import 'package:robocet_new/enums/difficulty.dart';
import 'package:robocet_new/models/failure_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child:Scaffold(
        ...
        body: quizQuestions.when(data:(questions)=> _buildBody(context,pageController,questions), 
...
class QuizQuestions extends StatelessWidget {
  ...
  const QuizQuestions({ Key? key, required this.pageController, required this.state, required this.questions
        ...
        itemBuilder: (BuildContext context, int index){
          ...
          return Column(
            ...
            children: [
              ...
              Padding(padding: 
              const EdgeInsets.fromLTRB(20.0,16.0,20.0,12.0),
              child: Text(
...
class AnswerCard extends StatelessWidget {
  ...
  required this.isSelected, required this.isCorrect, required this.isDisplayingAnswer, required this.onTap
